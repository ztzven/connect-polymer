        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    fileHash = crypto.createHash("SHA256").update(absolutePath + "/" + stats.mtime).digest("base64");
                    if (!!cache[fileHash]) return [3 /*break*/, 3];
                    return [4 /*yield*/, new Promise(function (resolve, reject) { return fs.readFile(absolutePath, "utf8", function (err, data) { return err ? reject(err) : resolve(data); }); })];
                case 2:
                    content = _a.sent();
                    ...
                    _a.label = 3;
                case 3: return [2 /*return*/, cache[fileHash]];
